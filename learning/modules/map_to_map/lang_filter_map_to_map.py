...
class LangFilterMapProcessor(MapTransformerBase):

    def __init__(self, source_map_size, world_size, embed_size, in_channels, out_channels, spatial=False, cat_out=False):
        super(LangFilterMapProcessor, self).__init__(source_map_size, world_size)
