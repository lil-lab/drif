...
from learning.models.semantic_map.sm_params import MAP_SIZE, WORLD_SIZE, MAP_WORLD_SIZE
...
class MapAffine(nn.Module):
    ...
    def get_old_to_new_pose_mat(self, old_pose, new_pose):
        ...
        #mat = new_T
        mat_t = np_to_tensor(mat, cuda=self.is_cuda)
        return mat_t
    ...
    def forward(self, maps, map_pose, cam_pose):
        ...
        affine_matrices = Variable(empty_float_tensor([batch_size, 3, 3], self.is_cuda, self.cuda_device))
