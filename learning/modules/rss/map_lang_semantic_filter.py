...
# TODO: Move the correct functionality here
class MapLangSemanticFilter(CudaModule):
    ...
    def precompute_conv_weights(self, text_embeddings):
        ...
        self.conv_weights = F.sigmoid(self.lang_gate_linear(text_embeddings))
    ...
    def forward(self, input):
        ...
        out = Variable(empty_float_tensor(out_size, cuda=self.is_cuda, device=self.cuda_device))
