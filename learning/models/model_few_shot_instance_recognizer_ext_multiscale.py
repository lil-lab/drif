...
class ModelFewShotInstanceRecognizerExtMultiscale(nn.Module):

    def __init__(self, run_name="", domain="sim"):
        super(ModelFewShotInstanceRecognizerExtMultiscale, self).__init__()
    ...
    def get_dataset(self, eval=False):
        ...
        return FewShotInstanceDataset(dataset_dir=dataset_dir, eval=eval, )
