...
# TODO: Get rid of this thing and just use the parameter server
from parameters.parameter_server import get_current_parameters, initialize_experiment
...
class RollOutParams:
    ...
    def loadPolicy(self):
        initialize_experiment(self.setup_name)
        self.params = get_current_parameters()["Rollout"]
