...
def get_state():
    global CURRENT_RUN, CURRENT_NAMESPACE, CURRENT_PARAMS, SETUP_NAME
...
def initialize_empty_experiment():
    global CURRENT_PARAMS, CURRENT_RUN, SETUP_NAME, CURRENT_NAMESPACE
    CURRENT_NAMESPACE = "Global"
    SETUP_NAME = {CURRENT_NAMESPACE: "Default"}
    CURRENT_RUN = {CURRENT_NAMESPACE: {}}
    CURRENT_PARAMS = {CURRENT_NAMESPACE: {}}
...
def initialize_experiment(setup_name=None):
    ...
    :return:
    """
    # Update the setup_name from the first command line argument if it is None
    params, setup_name = load_parameters(setup_name)
    ...
    SETUP_NAME = {CURRENT_NAMESPACE: setup_name}
...
def get_current_parameters():
    ...
    if CURRENT_PARAMS and CURRENT_NAMESPACE in CURRENT_PARAMS:
        return CURRENT_PARAMS[CURRENT_NAMESPACE]
    else:
        return None


def get(config_path, default=None, root=None):
    if not root:
...
def get_setup_name():
    global SETUP_NAME, CURRENT_NAMESPACE
    return SETUP_NAME[CURRENT_NAMESPACE]
